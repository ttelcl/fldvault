...
let usage focus =
  ...
  if showSection "bundles-fetch" then
    cp "\fogitvault \fybundles ingest \f0[\fg-f \fcwitnessfolder\f0|\fg-a \fcanchorname\f0[\fo::\fcreponame\f0]|\fg-all\f0]"
  ...
  if showSection "bundles-status" then
    cp "\fogitvault \fybundles status \f0[\fg-f \fcwitnessfolder\f0|\fg-a \fcanchorname\f0[\fo::\fcreponame\f0]|\fg-all\f0]"
