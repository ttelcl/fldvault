...
let usage focus =
  ...
  if showDetail "delta" then
    ...
    cp "  'Delta recipe' management and use: tooling for creating partial bundles."
    cp ""
    cp "\fogitvault \fydelta new\f0 [\fg-v1\f0|\fg-v2\f0] \fg-r \fcrecipe\f0 \fg-s \fcseed \fg-x \fcexclusion\f0"
    cp "\fogitvault \fydelta edit\f0 [\fg-r \fcrecipe\f0|\fg-R\f0] \fg-s \fcseed \fg-x \fcexclusion\f0 \fg-z \fczapref\f0"
    ...
    cp "  \fx   \fx    \fx        \fg-s\f0 can use specials \fo--branches\f0 and \fo--tags\f0 to include all local branches, and/or all tags."
